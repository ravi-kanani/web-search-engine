...
public class WebSearchEngineApplication {
	...
	public static void main(String[] args) throws Exception {
		...
		do {
			...
			System.out.println();
			SearchResults result = getSearchResults(str);
			if (!str.equalsIgnoreCase(result.getQuery())) {
				System.out.println("Showing results for '" + result.getQuery() + "' instead of '" + str + "'");
			}
			...
			System.out.println("\n");
			System.out.println("About " + result.getResults().size() + " results ("
